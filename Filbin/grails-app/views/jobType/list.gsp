...
<section id="list-jobType" class="first">
	...
	<table class="table table-bordered margin-top-medium">
		<thead>
			<tr>
				...
				<g:sortableColumn property="jsonFormText" title="${message(code: 'jobType.jsonFormText.label', default: 'Json Form Text')}" />
		...
		<g:each in="${jobTypeInstanceList}" status="i" var="jobTypeInstance">
			<tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
				...
				<%--<td>${fieldValue(bean: jobTypeInstance, field: "jsonFormText")}</td>
